...
class ED:
    ...
    def add_ts(self, start_level_id, end_level_id, ts_energy,
                color='k',
                ls='-',
                linewidth=1,
                ):
        '''
        Add TS line between energy levels
        '''
        self.tss[start_level_id].append((end_level_id, ts_energy, ls, linewidth, color))
    ...
    def plot(self, show_IDs=False):
        ...
        for idts, ts in enumerate(self.tss):
